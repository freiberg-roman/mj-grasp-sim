...
# Copyright (c) 2013, ROS-Industrial License: BSD-2-Clause
...
<compiler angle="radian" meshdir="assets" autolimits="true"/>
    ...
    <default class="2f85">
      ...
      <default class="collision">
        ...
        <default class="pad_box1">
          <geom mass="0" type="box" pos="0 -0.0026 0.028125" size="0.011 0.004 0.009375" friction="0.8"
            solimp="0.95 0.99 0.001" solref="0.004 1" priority="1" rgba="0.55 0.55 0.55 1"/>
        </default>
        <default class="pad_box2">
          <geom mass="0" type="box" pos="0 -0.0026 0.009375" size="0.011 0.004 0.009375" friction="0.8"
  ...
  <worldbody>
    ...
    <body name="base_mount" pos="{position}" quat="{quaternion}" childclass="2f85">
  ...
  <equality>
    ...
    <joint joint1="right_driver_joint" joint2="left_driver_joint" polycoef="0 1 0 0 0" solimp="0.95 0.99 0.001"
      solref="0.005 1"/>
    <weld body1="mocap" body2="base_mount"/>
  </equality>
  ...
  -->
  <actuator>
    <general class="2f85" name="fingers_actuator" tendon="split" forcerange="-100 100" ctrlrange="0 255"
      gainprm="0.3137255 0 0" biasprm="0 -100 -10"/>
  </actuator>
"""


class GripperRobotiq2f85(MjShakableOpenCloseGripper, MjScannable):
    def __init__(self, pose: SE3Pose):
        super().__init__(pose, "base_mount")

    def base_to_contact_transform(self) -> SE3Pose:
        return SE3Pose(
            np.array([0.0, 0.0, -0.15]), np.array([1, 0, 0, 0]), type="wxyz"
        )  # rotation and offset
    ...
    def to_xml(self) -> Tuple[str, Dict[str, Any]]:
        ...
        ASSETS = dict()
        base_path = os.path.join(ASSET_PATH, "robotiq2f85")
    ...
    def get_render_options(self):
        return super().get_render_options()
